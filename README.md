...
Minimal web UI for Jawon AI Chat.
...
> 3. In your **Jawon AI Chat** project, set an environment variable named `API_BASE_URL` with the value being the domain you got from deploying the palm proxy (`https://xxx.vercel.app`).
> 4. Redeploy your **Jawon AI Chat** project to finalize the configuration. This should resolve the issue.
>
